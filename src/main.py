from utils.audio_analysis import AudioProperties, SignalAnalyzer, SpectrumAnalyzer
from utils.utilities import AudioIOUtility
...
if __name__ == "__main__":
    ...
    save_filtered_data(filtered_data[1], " ", path_output, cutoff_freqs, "wav")
